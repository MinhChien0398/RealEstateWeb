...
<head>
    ...
    <link href="/template/lib/DataTables/DataTables-1.13.6/css/jquery.dataTables.min.css"
          rel="stylesheet">
    <link href="/template/lib/DataTables/DataTables-1.13.6/css/dataTables.bootstrap4.css"
          rel="stylesheet">
    <title>Title</title>
</head>
<body>
...
<div class="wrapper">
    ...
    <div class="sidebar">
        <div class="sidebar-menu">
            <center class="logo">
                <img src="/templateimg/logo/logo.png" alt="logo" style="">
            </center>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb p-0 bg-white">
                    ...
                    <li class="breadcrumb-item">
                        <a class="black-text" href="#">QL slide</a>
                    </li>
                    <li>
                        <i class="fas fa-caret-right mx-2 black-brown-text" aria-hidden="true"></i>
                    </li>
...
<script src="/template/lib/DataTables/DataTables-1.13.6/js/dataTables.bootstrap4.min.js"></script>
