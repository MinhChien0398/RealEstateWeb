...
<head>
    ...
    <link href="/template/lib/DataTables/DataTables-1.13.6/css/jquery.dataTables.min.css" rel="stylesheet">
    <link href="/template/lib/DataTables/datatables.min.css" rel="stylesheet">
    <link href="/template/css/admin-nav-bar.css" rel="stylesheet">
    <link href="/template/css/admin-datatable.css" rel="stylesheet">
        ...
        <div class="container p-0">
            <nav class="" aria-label="breadcrumb">
                <ol class="breadcrumb p-0 bg-white">
                    ...
                    <li class="breadcrumb-item"><a class="black-text" href="/template/servicePostsManage.html">QL Dịch vụ</a></li>
                    <li><i class="fas fa-caret-right mx-2 black-brown-text" aria-hidden="true"></i></li>
                    <li class="breadcrumb-item"><a class="main-color" href="/template/addServicesPage.html">Thêm dịch vụ</a></li>
                </ol>
            </nav>
